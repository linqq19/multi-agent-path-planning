...
class DataGenerator:
    ...
    def compute_own_dis_full(self,i,k,goal_i_mx,position_i_mx,pose_correct):
        ...
        if reach_point is not None:
            mid_points = self.global_map.find_midpoint(position_i_mx, reach_point)  # 中间点 用于增加计算信息
    ...
    def compute_neighbor_dis_full(self,i,j,k,goal_i_mx,position_i_mx,pose_correct):
